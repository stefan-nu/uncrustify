...
enum uo_t
{
   ...
   UO_indent_constr_colon,                  /**< indent stuff after a constructor colon */
...
/* UO_indent,                               TODO: 0=don't change indentation, 1=change indentation */
   ...
   UO_nl_brace_while,                 /**< newline between '}' and 'while' of do statement */
   ...
   UO_nl_func_call_paren,             /**< Add or remove newline between a function name and
                                       * the opening parenthesis '(' in the call */
   UO_nl_func_decl_start,             /**< newline after the '(' in a function declaration */
   ...
   UO_nl_func_decl_start_multi_line,  /**< newline after the '(' in a function declaration if '(' and ')'
                                       *   are on different lines */
   UO_nl_func_def_start_multi_line,   /**< newline after the '(' in a function def if '(' and ')'
                                       *   are on different lines */
   UO_nl_func_decl_args,              /**< newline after each ',' in a function declaration */
   UO_nl_func_def_args,               /**< Add or remove newline after each ',' in a function definition */
   UO_nl_func_decl_args_multi_line,   /**< newline after each ',' in a function declaration if '(' and ')'
                                       *   are on different lines */
   UO_nl_func_def_args_multi_line,    /**< Add or remove newline after each ',' in a function definition
                                       *   if '(' and ')' are on different lines */
   UO_nl_func_decl_end,               /**< newline before the ')' in a function declaration */
   UO_nl_func_def_end,                /**< newline before the ')' in a function definition */
   ...
   UO_nl_func_decl_end_multi_line,    /**< newline before the ')' in a function declaration if '(' and ')'
                                       *   are on different lines */
...
/* UO_ls_honor_newlines,               TODO: don't remove newlines on split lines */
   ...
   UO_ls_for_split_full,           /**< try to split long 'for' statements at semicolons */
...
void add_arg(
   ...
   argval_t   val  /**< [in] bit mask to add to option */
);
