...
dir /s/b %SRC_DIR%\align_stack.cpp		> .\%OUT_DIR%\files.lnt
dir /s/b %SRC_DIR%\align.cpp			>> .\%OUT_DIR%\files.lnt
...
dir /s/b %SRC_DIR%\braces.cpp			>> .\%OUT_DIR%\files.lnt
 rem dir /s/b %SRC_DIR%\chunk_list.cpp		>> .\%OUT_DIR%\files.lnt
dir /s/b %SRC_DIR%\ChunkStack.cpp		>> .\%OUT_DIR%\files.lnt
dir /s/b %SRC_DIR%\combine.cpp			>> .\%OUT_DIR%\files.lnt
 rem dir /s/b %SRC_DIR%\compat_posix.cpp		>> .\%OUT_DIR%\files.lnt
 rem dir /s/b %SRC_DIR%\compat_win32.cpp		>> .\%OUT_DIR%\files.lnt
dir /s/b %SRC_DIR%\defines.cpp			>> .\%OUT_DIR%\files.lnt
dir /s/b %SRC_DIR%\detect.cpp			>> .\%OUT_DIR%\files.lnt
dir /s/b %SRC_DIR%\indent.cpp 			>> .\%OUT_DIR%\files.lnt
...
rem dir /s/b %SRC_DIR%\space.cpp	 		>> .\%OUT_DIR%\files.lnt
 rem dir /s/b %SRC_DIR%\tabulator.cpp	 	>> .\%OUT_DIR%\files.lnt
