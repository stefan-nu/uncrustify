...
rem for C project
rem gcc -E -dM -O0 -g3 -c -fmessage-length=0 -Wno-format -std=gnu++0x .\%LNT_DIR%\empty.c > .\%LNT_DIR%\lint_cmac.h

rem for C++ project
rem g++ -E -dM -O0 -g3 -c -fmessage-length=0 -Wno-format -std=gnu++0x .\%LNT_DIR%\empty.c > .\%LNT_DIR%\lint_cppmac.h
