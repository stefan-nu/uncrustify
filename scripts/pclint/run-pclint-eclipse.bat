...
dir /s/b %SRC_DIR%\backup.cpp			>> .\%OUT_DIR%\files.lnt
...
dir /s/b %SRC_DIR%\uncrustify.cpp 		>> .\%OUT_DIR%\files.lnt
dir /s/b %SRC_DIR%\unicode.cpp 			>> .\%OUT_DIR%\files.lnt
dir /s/b %SRC_DIR%\universalindentgui.cpp 	>> .\%OUT_DIR%\files.lnt
