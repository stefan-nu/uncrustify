...
void register_options(void)
{
   ...
   unc_add_opt("indent_paren_after_func_def", UO_indent_paren_after_func_def, AT_BOOL,
               "Controls the indent of the open paren of a function definition, if on it's own line."
               "If True, indents the open paren");
   unc_add_opt("indent_paren_after_func_decl", UO_indent_paren_after_func_decl, AT_BOOL,
               "Controls the indent of the open paren of a function declaration, if on it's own line."
               "If True, indents the open paren");
   unc_add_opt("indent_paren_after_func_call", UO_indent_paren_after_func_call, AT_BOOL,
